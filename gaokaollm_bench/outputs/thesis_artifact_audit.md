...
- Created at: `2026-05-10T00:06:01`
...
| Check | Status | Detail |
|---|---|---|
| `required_artifacts_exist` | PASS | all required README, report, summary, and thesis docs exist |
...
| `successful_app_cases_have_evidence` | PASS | all successful app_pareto cases expose major_geo_relax or recommended_schools |
...
| `recorded_pytest_result_present` | PASS | thesis contribution doc records: 79 passed, 9 skipped, 1 warning |
