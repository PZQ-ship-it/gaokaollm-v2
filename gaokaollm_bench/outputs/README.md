...
- Benchmark pressure test: `multi_axis_v1` uses 30 personas to evaluate two-axis hidden flexibility; it is not part of the seven-experiment thesis table.
...
| Summaries | `agent_benchmark_*_summary.md` | Aggregate experiment results, plus `agent_benchmark_multi_axis_v1_summary.md` for the multi-axis pressure test. |
| Evidence appendices | `agent_benchmark_*_evidence.md`, `thesis_data_agent_benchmark_extension_evidence.md` | Per-case transcript evidence and baseline comparisons, including `agent_benchmark_multi_axis_v1_evidence.md` for the pressure test. |
