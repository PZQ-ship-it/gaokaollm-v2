...
|---|---:|---:|---:|---:|---:|---:|---:|
| v1_prompt_direct | 1 | 1 | 0 | 0.000 | 0.000 | 0.500 | 13.00 |
...
- `v1_prompt_direct` / `real-db-set-浙江-520-001`: success=False, pareto_gain=0, hallucination=0.500. 确定性裁判：未观察到命中隐藏妥协条件的学校和分数证据。
